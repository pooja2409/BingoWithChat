...
public class BingRand extends BingoCommon {
	...
	public BingRand() {
		...
		textAreaPingInBing = new TextArea();
		textAreaPingInBing.setBackground(new Color(255, 250, 240));
		textAreaPingInBing.setEditable(false);
		textAreaPingInBing.setBounds(665, 36, 275, 490);
		contentPane.add(textAreaPingInBing);

		textFieldPinginBing = new JTextField();
		textFieldPinginBing.setBounds(653, 544, 217, 32);
		contentPane.add(textFieldPinginBing);
		textFieldPinginBing.setColumns(10);
		...
		btnPingInBing.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String msgout = "";
					msgout = textFieldPinginBing.getText().trim();
					textFieldPinginBing.setText("");
	...
	public static void server() {
		try {
			...
			s = new Socket("172.16.115.215", 2425);// uncomment this line to
			// make it client
			din = new DataInputStream(s.getInputStream());
			dout = new DataOutputStream(s.getOutputStream());
			System.out.println(" Connection Successful for Gaming");
			sChat= new Socket("172.16.115.215",1201);
